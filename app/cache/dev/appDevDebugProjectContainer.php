...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'kernel.bundles' => array(
                ...
                'VoryxRESTGeneratorBundle' => 'Voryx\\RESTGeneratorBundle\\VoryxRESTGeneratorBundle',
            ...
            'locale' => 'en',
            'secret' => 'd9999bb26344519b9b1354027a587f41889ba227',
            ...
            'kernel.secret' => 'd9999bb26344519b9b1354027a587f41889ba227',
        ...
        $this->methodMap = array(
            ...
            'voryx.type.voryx_entity' => 'getVoryx_Type_VoryxEntityService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'root', 'password' => 'bV8cUFdMwd', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_db29a9815a45180d67d88a5bebbcffb06be29d3b24c245f1b4184eabf4c1a782');
    ...
    {
        return $this->services['fos_rest.converter.request_body'] = new \FOS\RestBundle\Request\RequestBodyParamConverter($this->get('fos_rest.serializer'), '', '', NULL, 'validationErrors');
    }
    ...
    {
        return $this->services['jms_serializer.datetime_handler'] = new \JMS\Serializer\Handler\DateHandler('Y-m-d\\TH:i:sO', 'Asia/Brunei', true);
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/symfony/swiftmailer-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\AsseticBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/symfony/assetic-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/doctrine/doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/sensio/framework-extra-bundle/Sensio/Bundle/FrameworkExtraBundle/Resources/config/serializer'), 'AppBundle' => (dirname(dirname(dirname(__DIR__))).'/src/AppBundle/Resources/config/serializer'), 'Voryx\\RESTGeneratorBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/voryx/restgeneratorbundle/src/Voryx/RESTGeneratorBundle/Resources/config/serializer'), 'FOS\\RestBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/friendsofsymfony/rest-bundle/FOS/RestBundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'Nelmio\\CorsBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/nelmio/cors-bundle/Nelmio/CorsBundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/config/serializer'), 'Acme\\DemoBundle' => (dirname(dirname(dirname(__DIR__))).'/src/Acme/DemoBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/sensio/generator-bundle/Sensio/Bundle/GeneratorBundle/Resources/config/serializer')));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('d9999bb26344519b9b1354027a587f41889ba227');
    }
    ...
    /**
     * Gets the 'voryx.type.voryx_entity' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Voryx\RESTGeneratorBundle\Form\Type\VoryxEntityType A Voryx\RESTGeneratorBundle\Form\Type\VoryxEntityType instance.
     */
    protected function getVoryx_Type_VoryxEntityService()
    {
        return $this->services['voryx.type.voryx_entity'] = new \Voryx\RESTGeneratorBundle\Form\Type\VoryxEntityType($this->get('doctrine.orm.default_entity_manager'));
    }
